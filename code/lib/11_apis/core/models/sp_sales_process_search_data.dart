...
class SPSalesProcessSearchData {
  SPSalesProcessSearchData({
    this.salesId,
    this.userCodeOwner,
    this.customerCode,
  ...
  factory SPSalesProcessSearchData.fromRawJson(String str) => SPSalesProcessSearchData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SPSalesProcessSearchData.fromJson(Map<String, dynamic> json) => SPSalesProcessSearchData(
    ...
    listSalesProcessDtl: List<ListSalesProcessDtl>.from((json["ListSalesProcessDtl"]??[]).map((x) => ListSalesProcessDtl.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "ListSalesProcessDtl": List<dynamic>.from((listSalesProcessDtl??[]).map((x) => x.toJson())),
