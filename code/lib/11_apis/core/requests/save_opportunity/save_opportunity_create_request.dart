...
class SaveOpportunityCreateRequest extends IdealerApiRequest {
  SaveOpportunityCreateRequest(SaveSpSaleProcessData saveSPSalesProcess) {
    endpoint = "Services/SalesProcess_Create";
